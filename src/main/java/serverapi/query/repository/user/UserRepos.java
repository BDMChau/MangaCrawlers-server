...
//    Optional<UserDTO> getUser(Long UserDTO);
    ...
    @Query("""
            SELECT new serverapi.query.dtos.tables.UserDTO(u.user_id, u.user_name, u.user_email, u.user_avatar, u.socket_session_id, u.user_desc, transgr.transgroup_id, transgr.transgroup_name) 
